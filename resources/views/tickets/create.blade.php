                    ...
                    <form action="{{ route('ticket.store') }}" class="w-full max-w-md" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            text-gray-500 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" name="description"
                             id="description" cols="30" rows="10">Ticket's description</textarea>
                        </div>
                        ...
                        <div class="grid grid-cols-4 gap-2">
                            <div class="mb-3 col-span-2">
                                ...
                                <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 
                                text-gray-500 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="deadline" name="deadline" type="date">
                            </div>
