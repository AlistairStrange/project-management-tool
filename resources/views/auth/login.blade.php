                    ...
                    <form class="w-full p-6" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="flex mb-6">
                            <label class="inline-flex items-center text-sm text-gray-700" for="remember">
                                <input type="checkbox" name="remember" id="remember" class="form-checkbox text-teal-400" {{ old('remember') ? 'checked' : '' }}>
                        ...
                        <div class="flex flex-wrap items-center">
                            ...
                            @if (Route::has('password.request'))
                                <a class="text-sm text-teal-400 hover:text-teal-500 whitespace-no-wrap no-underline ml-auto" href="{{ route('password.request') }}">
